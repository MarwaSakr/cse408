        ...
        try {
            ...
            for(int i = 0; i < signal.height; i++)
            {
                for(int j = 0; j < signal.width; j++)
                {
                    ...
                    signal.Ynew[count] = (int) ColorConversion.YUV_Y;
					signal.Unew[count] = (int) ColorConversion.YUV_U;
                    signal.Vnew[count] = (int) ColorConversion.YUV_V;
                    count++;
